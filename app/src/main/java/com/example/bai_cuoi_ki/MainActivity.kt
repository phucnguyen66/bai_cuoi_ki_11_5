...
fun push50AdvancedQuestionsToFirebase() {
    ...
    val danhSachCauHoi = mapOf(
        "1" to mapOf(
            "deBai" to "Câu 1: Giải phương trình \\( x^2 - 5x + 6 = 0 \\).",
            "dapan" to "x = 2, 3",
            "sai1" to "x = 1, 5",
            "sai2" to "x = -1, 6",
            "sai3" to "x = 0, 4"
        ...
        "2" to mapOf(
            "deBai" to "Câu 2: Tính diện tích hình vuông có cạnh 10 cm.",
            "dapan" to "100 cm²",
            "sai1" to "120 cm²",
            "sai2" to "110 cm²",
            "sai3" to "90 cm²"
        ...
        "3" to mapOf(
            "deBai" to "Câu 3: Tính chu vi hình tròn có bán kính r = 5 cm.",
            "dapan" to "C = 10π cm",
            "sai1" to "C = 5π cm",
            "sai2" to "C = 2π cm",
            "sai3" to "C = 8π cm"
        ...
        "4" to mapOf(
            "deBai" to "Câu 4: Tính diện tích tam giác vuông có cạnh góc vuông là 6 cm và 8 cm.",
            "dapan" to "24 cm²",
            "sai1" to "48 cm²",
            "sai2" to "30 cm²",
            "sai3" to "18 cm²"
        ...
        "5" to mapOf(
            "deBai" to "Câu 5: Giải hệ phương trình \\( x + y = 10 \\), \\( x - y = 2 \\).",
            "dapan" to "x = 6, y = 4",
            "sai1" to "x = 4, y = 6",
            "sai2" to "x = 5, y = 5",
            "sai3" to "x = 7, y = 3"
        ...
        "6" to mapOf(
            "deBai" to "Câu 6: Tính thể tích hình hộp chữ nhật có chiều dài 5 cm, rộng 4 cm và cao 3 cm.",
            "dapan" to "60 cm³",
            "sai1" to "50 cm³",
            "sai2" to "70 cm³",
            "sai3" to "40 cm³"
        ...
        "7" to mapOf(
            "deBai" to "Câu 7: Giải phương trình \\( 2x + 3 = 7 \\).",
            "dapan" to "x = 2",
            "sai1" to "x = 1",
            "sai2" to "x = 3",
            "sai3" to "x = 4"
        ...
        "8" to mapOf(
            "deBai" to "Câu 8: Tính diện tích hình tròn có bán kính 7 cm.",
            "dapan" to "49π cm²",
            "sai1" to "14π cm²",
            "sai2" to "35π cm²",
            "sai3" to "70π cm²"
        ...
        "9" to mapOf(
            "deBai" to "Câu 9: Giải phương trình \\( x^2 + 4x + 3 = 0 \\).",
            "dapan" to "x = -1, -3",
            "sai1" to "x = 1, -3",
            "sai2" to "x = -1, 3",
            "sai3" to "x = 1, 3"
        ...
        "10" to mapOf(
            "deBai" to "Câu 10: Tính diện tích hình thang có đáy lớn 12 cm, đáy nhỏ 8 cm, chiều cao 5 cm.",
            "dapan" to "50 cm²",
            "sai1" to "60 cm²",
            "sai2" to "40 cm²",
            "sai3" to "45 cm²"
        ...
        "11" to mapOf(
            "deBai" to "Câu 11: Tính diện tích hình chữ nhật có chiều dài 15 cm và chiều rộng 8 cm.",
            "dapan" to "120 cm²",
            "sai1" to "130 cm²",
            "sai2" to "110 cm²",
            "sai3" to "100 cm²"
        ...
        "12" to mapOf(
            "deBai" to "Câu 12: Giải phương trình \\( x^2 - 4x = 0 \\).",
            "dapan" to "x = 0, 4",
            "sai1" to "x = 0, -4",
            "sai2" to "x = -2, 2",
            "sai3" to "x = 1, 3"
        ...
        "13" to mapOf(
            "deBai" to "Câu 13: Tính chu vi tam giác vuông có cạnh góc vuông 3 cm và 4 cm.",
            "dapan" to "12 cm",
            "sai1" to "10 cm",
            "sai2" to "14 cm",
            "sai3" to "15 cm"
        ...
        "14" to mapOf(
            "deBai" to "Câu 14: Tính diện tích hình tròn có bán kính 9 cm.",
            "dapan" to "81π cm²",
            "sai1" to "72π cm²",
            "sai2" to "90π cm²",
            "sai3" to "100π cm²"
        ...
        "15" to mapOf(
            "deBai" to "Câu 15: Giải phương trình \\( 3x - 2 = 10 \\).",
            "dapan" to "x = 4",
            "sai1" to "x = 3",
            "sai2" to "x = 2",
            "sai3" to "x = 5"
        ...
        "16" to mapOf(
            "deBai" to "Câu 16: Tính thể tích hình cầu có bán kính 4 cm.",
            "dapan" to "\\( \\frac{4}{3}π(4^3) \\) cm³",
            "sai1" to "\\( \\frac{4}{3}π(3^3) \\) cm³",
            "sai2" to "\\( \\frac{4}{3}π(5^3) \\) cm³",
            "sai3" to "\\( \\frac{4}{3}π(6^3) \\) cm³"
        ),
        "17" to mapOf(
            "deBai" to "Câu 17: Tính chu vi hình chữ nhật có chiều dài 10 cm và chiều rộng 5 cm.",
            "dapan" to "30 cm",
            "sai1" to "25 cm",
            "sai2" to "35 cm",
            "sai3" to "40 cm"
        ...
        "18" to mapOf(
            "deBai" to "Câu 18: Giải phương trình \\( x^2 + 2x - 3 = 0 \\).",
            "dapan" to "x = 1, -3",
            "sai1" to "x = 2, -1",
            "sai2" to "x = -1, 3",
            "sai3" to "x = 0, 1"
        ...
        "19" to mapOf(
            "deBai" to "Câu 19: Tính diện tích tam giác vuông có cạnh góc vuông 7 cm và 24 cm.",
            "dapan" to "84 cm²",
            "sai1" to "96 cm²",
            "sai2" to "72 cm²",
            "sai3" to "88 cm²"
        ...
        "20" to mapOf(
            "deBai" to "Câu 20: Tính thể tích hình lăng trụ tam giác có diện tích đáy 12 cm² và chiều cao 6 cm.",
            "dapan" to "72 cm³",
            "sai1" to "60 cm³",
            "sai2" to "80 cm³",
            "sai3" to "90 cm³"
            ...
            "21" to mapOf(
                "deBai" to "Câu 21: Tính chu vi hình vuông có cạnh 15 cm.",
                "dapan" to "60 cm",
                "sai1" to "55 cm",
                "sai2" to "50 cm",
                "sai3" to "65 cm"
    ...
    "22" to mapOf(
        "deBai" to "Câu 22: Giải phương trình \\( x^2 - 9 = 0 \\).",
        "dapan" to "x = 3, -3",
        "sai1" to "x = 1, -3",
        "sai2" to "x = -2, 3",
        "sai3" to "x = 0, 3"
    ...
    "23" to mapOf(
        "deBai" to "Câu 23: Tính diện tích hình chữ nhật có chiều dài 20 cm và chiều rộng 12 cm.",
        "dapan" to "240 cm²",
        "sai1" to "220 cm²",
        "sai2" to "230 cm²",
        "sai3" to "250 cm²"
    ...
    "24" to mapOf(
        "deBai" to "Câu 24: Tính diện tích tam giác vuông có cạnh góc vuông 9 cm và 12 cm.",
        "dapan" to "54 cm²",
        "sai1" to "60 cm²",
        "sai2" to "72 cm²",
        "sai3" to "48 cm²"
    ...
    "25" to mapOf(
        "deBai" to "Câu 25: Giải phương trình \\( x^2 - 7x + 10 = 0 \\).",
        "dapan" to "x = 2, 5",
        "sai1" to "x = 1, 6",
        "sai2" to "x = 3, 4",
        "sai3" to "x = 0, 7"
    ...
    "26" to mapOf(
        "deBai" to "Câu 26: Tính chu vi hình tròn có bán kính 10 cm.",
        "dapan" to "20π cm",
        "sai1" to "30π cm",
        "sai2" to "10π cm",
        "sai3" to "25π cm"
    ...
    "27" to mapOf(
        "deBai" to "Câu 27: Giải phương trình \\( x^2 + 2x - 8 = 0 \\).",
        "dapan" to "x = 2, -4",
        "sai1" to "x = -2, 4",
        "sai2" to "x = 3, -5",
        "sai3" to "x = -3, 5"
    ...
    "28" to mapOf(
        "deBai" to "Câu 28: Tính diện tích hình vuông có cạnh 6 cm.",
        "dapan" to "36 cm²",
        "sai1" to "30 cm²",
        "sai2" to "40 cm²",
        "sai3" to "50 cm²"
    ...
    "29" to mapOf(
        "deBai" to "Câu 29: Tính thể tích hình hộp chữ nhật có chiều dài 10 cm, rộng 5 cm và cao 4 cm.",
        "dapan" to "200 cm³",
        "sai1" to "180 cm³",
        "sai2" to "220 cm³",
        "sai3" to "240 cm³"
    ...
    "30" to mapOf(
        "deBai" to "Câu 30: Giải phương trình \\( x^2 - 3x - 4 = 0 \\).",
        "dapan" to "x = 4, -1",
        "sai1" to "x = 3, -2",
        "sai2" to "x = 5, -3",
        "sai3" to "x = 6, 1"
    ...
    "31" to mapOf(
        "deBai" to "Câu 31: Tính diện tích hình tròn có bán kính 5 cm.",
        "dapan" to "25π cm²",
        "sai1" to "30π cm²",
        "sai2" to "20π cm²",
        "sai3" to "35π cm²"
    ...
    "32" to mapOf(
        "deBai" to "Câu 32: Giải phương trình \\( x^2 + 5x + 6 = 0 \\).",
        "dapan" to "x = -2, -3",
        "sai1" to "x = 2, -3",
        "sai2" to "x = -1, 6",
        "sai3" to "x = 0, 5"
    ...
    "33" to mapOf(
        "deBai" to "Câu 33: Tính diện tích tam giác vuông có cạnh góc vuông 8 cm và 15 cm.",
        "dapan" to "60 cm²",
        "sai1" to "70 cm²",
        "sai2" to "50 cm²",
        "sai3" to "65 cm²"
    ...
    "34" to mapOf(
        "deBai" to "Câu 34: Tính thể tích hình cầu có bán kính 3 cm.",
        "dapan" to "\\( \\frac{4}{3}π(3^3) \\) cm³",
        "sai1" to "\\( \\frac{4}{3}π(2^3) \\) cm³",
        "sai2" to "\\( \\frac{4}{3}π(4^3) \\) cm³",
        "sai3" to "\\( \\frac{4}{3}π(5^3) \\) cm³"
    ),
    "35" to mapOf(
        "deBai" to "Câu 35: Tính chu vi tam giác vuông có cạnh góc vuông 9 cm và 12 cm.",
        "dapan" to "30 cm",
        "sai1" to "25 cm",
        "sai2" to "35 cm",
        "sai3" to "40 cm"
    ...
    "36" to mapOf(
        "deBai" to "Câu 36: Giải phương trình \\( x^2 - 6x + 9 = 0 \\).",
        "dapan" to "x = 3",
        "sai1" to "x = 4",
        "sai2" to "x = -3",
        "sai3" to "x = 5"
    ...
    "37" to mapOf(
        "deBai" to "Câu 37: Tính diện tích hình tròn có bán kính 11 cm.",
        "dapan" to "121π cm²",
        "sai1" to "100π cm²",
        "sai2" to "110π cm²",
        "sai3" to "130π cm²"
    ...
    "38" to mapOf(
        "deBai" to "Câu 38: Tính diện tích hình chữ nhật có chiều dài 30 cm và chiều rộng 10 cm.",
        "dapan" to "300 cm²",
        "sai1" to "320 cm²",
        "sai2" to "330 cm²",
        "sai3" to "350 cm²"
    ...
    "39" to mapOf(
        "deBai" to "Câu 39: Giải phương trình \\( x^2 - 3x + 2 = 0 \\).",
        "dapan" to "x = 1, 2",
        "sai1" to "x = 0, -2",
        "sai2" to "x = -1, 3",
        "sai3" to "x = 4, -1"
    ...
    "40" to mapOf(
        "deBai" to "Câu 40: Tính diện tích tam giác vuông có cạnh góc vuông 10 cm và 24 cm.",
        "dapan" to "120 cm²",
        "sai1" to "110 cm²",
        "sai2" to "130 cm²",
        "sai3" to "140 cm²"
    ...
    "41" to mapOf(
        "deBai" to "Câu 41: Tính thể tích hình hộp chữ nhật có chiều dài 6 cm, chiều rộng 8 cm và chiều cao 5 cm.",
        "dapan" to "240 cm³",
        "sai1" to "250 cm³",
        "sai2" to "220 cm³",
        "sai3" to "230 cm³"
    ...
    "42" to mapOf(
        "deBai" to "Câu 42: Tính chu vi hình tròn có bán kính 12 cm.",
        "dapan" to "24π cm",
        "sai1" to "20π cm",
        "sai2" to "30π cm",
        "sai3" to "18π cm"
    ...
    "43" to mapOf(
        "deBai" to "Câu 43: Giải phương trình \\( x^2 + 3x - 4 = 0 \\).",
        "dapan" to "x = 1, -4",
        "sai1" to "x = -1, 4",
        "sai2" to "x = 2, -5",
        "sai3" to "x = -2, 5"
    ...
    "44" to mapOf(
        "deBai" to "Câu 44: Tính diện tích hình vuông có cạnh 20 cm.",
        "dapan" to "400 cm²",
        "sai1" to "350 cm²",
        "sai2" to "450 cm²",
        "sai3" to "500 cm²"
    ...
    "45" to mapOf(
        "deBai" to "Câu 45: Tính thể tích hình cầu có bán kính 6 cm.",
        "dapan" to "\\( \\frac{4}{3}π(6^3) \\) cm³",
        "sai1" to "\\( \\frac{4}{3}π(5^3) \\) cm³",
        "sai2" to "\\( \\frac{4}{3}π(7^3) \\) cm³",
        "sai3" to "\\( \\frac{4}{3}π(8^3) \\) cm³"
    ),
    "46" to mapOf(
        "deBai" to "Câu 46: Tính diện tích tam giác vuông có cạnh góc vuông 5 cm và 12 cm.",
        "dapan" to "30 cm²",
        "sai1" to "35 cm²",
        "sai2" to "40 cm²",
        "sai3" to "45 cm²"
    ...
    "47" to mapOf(
        "deBai" to "Câu 47: Giải phương trình \\( x^2 - 5x + 4 = 0 \\).",
        "dapan" to "x = 1, 4",
        "sai1" to "x = -1, 5",
        "sai2" to "x = 0, 4",
        "sai3" to "x = 2, 3"
    ...
    "48" to mapOf(
        "deBai" to "Câu 48: Tính chu vi hình tròn có bán kính 8 cm.",
        "dapan" to "16π cm",
        "sai1" to "14π cm",
        "sai2" to "18π cm",
        "sai3" to "20π cm"
    ...
    "49" to mapOf(
        "deBai" to "Câu 49: Giải phương trình \\( x^2 - 2x - 3 = 0 \\).",
        "dapan" to "x = 3, -1",
        "sai1" to "x = -3, 1",
        "sai2" to "x = 4, -2",
        "sai3" to "x = -2, 2"
    ...
    "50" to mapOf(
        "deBai" to "Câu 50: Tính diện tích hình chữ nhật có chiều dài 18 cm và chiều rộng 9 cm.",
        "dapan" to "162 cm²",
        "sai1" to "150 cm²",
        "sai2" to "170 cm²",
        "sai3" to "180 cm²"
